...
const jsonUrl = 'https://raw.githubusercontent.com/Sam-3-git/Azure-RoleAdvisor/refs/heads/main/webscraper/AzureRoleAdvisor.json';
...
chrome.runtime.onInstalled.addListener(() => {
  fetch(jsonUrl)
    ...
    .then(data => {
      ...
      console.log("RBAC data stored successfully!");
    })
